...
CREATE TABLE IF NOT EXISTS `locations` (
  ...
  `language` char(2) COLLATE utf8mb4_bin DEFAULT NULL,
  `formatted_address` varchar(160) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `facebook_id` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `facebook_name` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL,
  `facebook_data` text COLLATE utf8mb4_bin,
  `linkedin_id` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL,
  `linkedin_name` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL,
  `linkedin_data` text COLLATE utf8mb4_bin,
  `gplus_id` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `gplus_name` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL,
  `gplus_data` text COLLATE utf8mb4_bin,
  `twitter_id` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `twitter_name` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL,
  `twitter_data` text COLLATE utf8mb4_bin,
...
CREATE TABLE IF NOT EXISTS `user_email_confirmations` (
  ...
  `code` char(32) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_failed_logins` (
  ...
  `ip_address` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_notifications` (
  ...
  `object_source` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Object source can be a table. For example, articles. Then object_id is the id from article table',
...
CREATE TABLE IF NOT EXISTS `user_password_changes` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `ip_address` char(15) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_permissions` (
  ...
  `group_id` tinyint(3) unsigned NOT NULL,
  `resource` varchar(16) COLLATE utf8mb4_bin NOT NULL,
  `action` varchar(16) COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`id`),
  KEY `group_id` (`group_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=123 ;
...
CREATE TABLE IF NOT EXISTS `user_remember_tokens` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `token` char(32) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_reset_passwords` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `code` varchar(48) COLLATE utf8mb4_bin NOT NULL,
  `created_at` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_success_logins` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin AUTO_INCREMENT=238 ;
